...
macos-exec:
	$(CXX) -stdlib=libc++ -mmacosx-version-min=10.14 -I/usr/local/opt/openssl/include -I ./src -I $(UWS_PATH)/src -I $(USOCKETS_PATH)/src -I -DLIBUS_USE_OPENSSL -L/usr/local/opt/openssl/lib -lstdc++ -pthread -fPIC -std=c++17 -c -O3 ./src/*.cpp 
	$(CXX) -stdlib=libc++ -mmacosx-version-min=10.14 *.o $(USOCKETS_PATH)/usockets_macos_$(ARCH).a -L/usr/local/opt/openssl/lib -lstdc++ -pthread -fPIC -lz -std=c++17 -o $(EXEC_NAME)
...
macos-exec-arm64:
	$(CXX) -stdlib=libc++ -target arm64-apple-macos11 -I/usr/local/opt/openssl/include -I ./src -I $(UWS_PATH)/src -I $(USOCKETS_PATH)/src -I -DLIBUS_USE_OPENSSL -L/usr/local/opt/openssl/lib -lstdc++ -pthread -fPIC -std=c++17 -c -O3 ./src/*.cpp 
	$(CXX) -stdlib=libc++ -target arm64-apple-macos11 *.o $(USOCKETS_PATH)/usockets_macos_arm64.a -L/usr/local/opt/openssl/lib -lstdc++ -pthread -fPIC -lz -std=c++17 -o $(EXEC_NAME)
