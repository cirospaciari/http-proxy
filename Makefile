...
macos-exec:
	...
	$(CXX) -stdlib=libc++ -mmacosx-version-min=10.14 *.o $(USOCKETS_PATH)/usockets_macos_$(ARCH).a -L/usr/local/opt/openssl/lib -lcrypto -lstdc++ -pthread -fPIC -lz -std=c++17 -o $(EXEC_NAME)
